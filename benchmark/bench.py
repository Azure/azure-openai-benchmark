...
def main():
    ...
    load_parser.add_argument("--context-message-source", type=str, default="generate", help="Source of context messages to be used during testing.", choices=["generate", "replay"])
