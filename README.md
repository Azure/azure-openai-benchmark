...
> :warning: **This project does not support testing more than 900 PTUs. For larger instances please use other tools like JMeter/Gatling/etc for stress testing.**
